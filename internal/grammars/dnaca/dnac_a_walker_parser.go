...
var parserATN = []uint16{
	3, 24715, 42794, 33075, 47597, 16764, 15335, 30598, 22884, 3, 59, 151,
	...
	22, 7, 27, 2, 2, 22, 23, 7, 2, 2, 3, 23, 3, 3, 2, 2, 2, 24, 42, 7, 57,
	2, 2, 25, 29, 7, 26, 2, 2, 26, 28, 5, 8, 5, 2, 27, 26, 3, 2, 2, 2, 28,
	31, 3, 2, 2, 2, 29, 27, 3, 2, 2, 2, 29, 30, 3, 2, 2, 2, 30, 33, 3, 2, 2,
	2, 31, 29, 3, 2, 2, 2, 32, 34, 7, 41, 2, 2, 33, 32, 3, 2, 2, 2, 33, 34,
	...
	43, 3, 2, 2, 2, 43, 5, 3, 2, 2, 2, 44, 91, 5, 4, 3, 2, 45, 66, 7, 40, 2,
	2, 46, 50, 7, 26, 2, 2, 47, 49, 5, 8, 5, 2, 48, 47, 3, 2, 2, 2, 49, 52,
	3, 2, 2, 2, 50, 48, 3, 2, 2, 2, 50, 51, 3, 2, 2, 2, 51, 54, 3, 2, 2, 2,
	52, 50, 3, 2, 2, 2, 53, 55, 7, 41, 2, 2, 54, 53, 3, 2, 2, 2, 54, 55, 3,
	...
	66, 67, 3, 2, 2, 2, 67, 91, 3, 2, 2, 2, 68, 69, 7, 58, 2, 2, 69, 70, 7,
	26, 2, 2, 70, 71, 5, 14, 8, 2, 71, 72, 7, 27, 2, 2, 72, 91, 3, 2, 2, 2,
	73, 88, 7, 44, 2, 2, 74, 78, 7, 26, 2, 2, 75, 77, 5, 8, 5, 2, 76, 75, 3,
	...
	97, 98, 3, 2, 2, 2, 98, 9, 3, 2, 2, 2, 99, 108, 7, 42, 2, 2, 100, 102,
	...
	109, 3, 2, 2, 2, 109, 11, 3, 2, 2, 2, 110, 119, 7, 43, 2, 2, 111, 113,
	...
	120, 3, 2, 2, 2, 120, 13, 3, 2, 2, 2, 121, 149, 7, 46, 2, 2, 122, 149,
	7, 47, 2, 2, 123, 149, 7, 48, 2, 2, 124, 149, 7, 49, 2, 2, 125, 149, 7,
	50, 2, 2, 126, 135, 7, 51, 2, 2, 127, 129, 7, 26, 2, 2, 128, 130, 5, 14,
	...
	3, 2, 2, 2, 137, 146, 7, 52, 2, 2, 138, 140, 7, 26, 2, 2, 139, 141, 5,
...
const (
	...
	DNAC_A_WalkerAnnotationNotScoped = 33
	DNAC_A_WalkerAnnotationScoped    = 34
	DNAC_A_WalkerStruct              = 35
	DNAC_A_WalkerUnion               = 36
	DNAC_A_WalkerNewtype             = 37
	DNAC_A_WalkerType                = 38
	DNAC_A_WalkerTypeParam           = 39
	DNAC_A_WalkerTypeExpr            = 40
	DNAC_A_WalkerTypeExprElem        = 41
	DNAC_A_WalkerField               = 42
	DNAC_A_WalkerJson                = 43
	DNAC_A_WalkerJsonStr             = 44
	DNAC_A_WalkerJsonBool            = 45
	DNAC_A_WalkerJsonNull            = 46
	DNAC_A_WalkerJsonInt             = 47
	DNAC_A_WalkerJsonFloat           = 48
	DNAC_A_WalkerJsonArray           = 49
	DNAC_A_WalkerJsonObj             = 50
	DNAC_A_WalkerModuleAnno          = 51
	DNAC_A_WalkerDeclAnno            = 52
	DNAC_A_WalkerFieldAnno           = 53
	DNAC_A_WalkerDNAC                = 54
	DNAC_A_WalkerName                = 55
	DNAC_A_WalkerExnotation          = 56
	DNAC_A_WalkerDefault             = 57
)
...
func (p *DNAC_A_Walker) Name() (localctx INameContext) {
	...
	if _la == DNAC_A_WalkerDOWN {
		...
		for ((_la-38)&-(0x1f+1)) == 0 && ((1<<uint((_la-38)))&((1<<(DNAC_A_WalkerType-38))|(1<<(DNAC_A_WalkerField-38))|(1<<(DNAC_A_WalkerName-38))|(1<<(DNAC_A_WalkerExnotation-38)))) != 0 {
			{
				p.SetState(33)
				p.Tld()
			}
...
func (p *DNAC_A_Walker) Tld() (localctx ITldContext) {
	...
	case DNAC_A_WalkerType:
		...
		if _la == DNAC_A_WalkerDOWN {
			...
			for ((_la-44)&-(0x1f+1)) == 0 && ((1<<uint((_la-44)))&((1<<(DNAC_A_WalkerJsonStr-44))|(1<<(DNAC_A_WalkerJsonBool-44))|(1<<(DNAC_A_WalkerJsonNull-44))|(1<<(DNAC_A_WalkerJsonInt-44))|(1<<(DNAC_A_WalkerJsonFloat-44))|(1<<(DNAC_A_WalkerJsonArray-44))|(1<<(DNAC_A_WalkerJsonObj-44)))) != 0 {
				{
					p.SetState(57)
					p.JsonVal()
				}
	...
	case DNAC_A_WalkerField:
		...
		if _la == DNAC_A_WalkerDOWN {
			...
			if ((_la-44)&-(0x1f+1)) == 0 && ((1<<uint((_la-44)))&((1<<(DNAC_A_WalkerJsonStr-44))|(1<<(DNAC_A_WalkerJsonBool-44))|(1<<(DNAC_A_WalkerJsonNull-44))|(1<<(DNAC_A_WalkerJsonInt-44))|(1<<(DNAC_A_WalkerJsonFloat-44))|(1<<(DNAC_A_WalkerJsonArray-44))|(1<<(DNAC_A_WalkerJsonObj-44)))) != 0 {
				{
					p.SetState(82)
					p.JsonVal()
				}
...
func (p *DNAC_A_Walker) JsonVal() (localctx IJsonValContext) {
	...
	case DNAC_A_WalkerJsonArray:
		...
		if _la == DNAC_A_WalkerDOWN {
			...
			for ok := true; ok; ok = (((_la-44)&-(0x1f+1)) == 0 && ((1<<uint((_la-44)))&((1<<(DNAC_A_WalkerJsonStr-44))|(1<<(DNAC_A_WalkerJsonBool-44))|(1<<(DNAC_A_WalkerJsonNull-44))|(1<<(DNAC_A_WalkerJsonInt-44))|(1<<(DNAC_A_WalkerJsonFloat-44))|(1<<(DNAC_A_WalkerJsonArray-44))|(1<<(DNAC_A_WalkerJsonObj-44)))) != 0) {
				{
					p.SetState(126)
					p.JsonVal()
				}
